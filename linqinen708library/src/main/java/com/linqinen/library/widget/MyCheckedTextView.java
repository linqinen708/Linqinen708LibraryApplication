...
//    private ColorStateList mtv_solid_color;
...
//        refreshDrawableState();
    ...
    public void setMtv_solid_color(String mtvSolidColor) {
        if(TextUtils.isEmpty(mtvSolidColor)){
            return;
        }
        int colorInt = Color.parseColor(mtvSolidColor);
        mSolidColor = ColorStateList.valueOf(colorInt);
        mNormalGradientDrawable.setColor(colorInt);
        setBackground(getFinalBackgroundDrawable());
    }
