//package com.linqinen.library.widget.dashboardview;
//
...
//
//    //临时使用的收缩值
//    private int shrink = 40;
//    private int sliceShrink = 20;
//
...
//        mBitmap = a.getResourceId(R.styleable.DashboardView_bitmap,R.drawable.breathing_heart_rate_icon_heart);
//
//        a.recycle();
//
//        initObjects();
...
//            } else {
//                strings[i] = String.valueOf(mMinValue+((mMaxValue - mMinValue) / mBigSliceCount) * i);
//            }
//        }
//
//        return strings;
...
//        }
////        LogT.i("11111widthMode:" +widthMode + ", widthSize:"  + widthSize+",heightMode:" +heightMode + ", heightSize:"  + heightSize);
...
//        canvas.drawBitmap(BitmapFactory.decodeResource(getResources(), mBitmap), mCenterX, mCenterY/3*2, mPaintPointer);
//        Paint p = new Paint();
//        p.setAntiAlias(true);
//        p.setColor(getResources().getColor(R.color.green_8000ff00));
////        p.setStyle(Paint.Style.STROKE);
//        canvas.drawCircle(mCenterX, mCenterY, mCenterX-mStripeWidth-5-shrink, p);
//        p.setColor(getResources().getColor(R.color.grey_999999));
//       p.setStyle(Paint.Style.STROKE);
//        canvas.drawCircle(mCenterX, mCenterY, mCenterX-mStripeWidth-4-shrink, p);
//    }
//
//    /**
//     * 绘制色带
...
//                    canvas.drawArc(mRectStripe, highlightCR.getStartAngle(), highlightCR.getSweepAngle(), false, mPaintStripe);
//                } else {
//                    canvas.drawArc(mRectStripe, highlightCR.getStartAngle(), mStartAngle + mSweepAngle - highlightCR.getStartAngle(), false, mPaintStripe);
//                    break;
//                }
//            }
//        }
////        int[] colors = {getResources().getColor(R.color.red_ff4639),0xffffff,0xffffff,getResources().getColor(R.color.red_ff4639),
////                getResources().getColor(R.color.red_ff4639), getResources().getColor(R.color.yellow_CDD513), getResources().getColor(R.color.green_3CDF5F)
////                ,getResources().getColor(R.color.yellow_CDD513),getResources().getColor(R.color.red_ff4639)};
////        SweepGradient sweepGradient = new SweepGradient(mCenterX, mCenterY, colors, null);
////        //旋转 不然是从0度开始渐变
////        Matrix matrix = new Matrix();
////        matrix.setRotate(mStartAngle+mSweepAngle-360, mCenterX, mCenterY);
////        sweepGradient.setLocalMatrix(matrix);
////        mPaintStripe.setShader(sweepGradient);
////        LogT.i("mStartAngle:" + mStartAngle+",mSweepAngle:"+mSweepAngle+",mCenterX:"+mCenterX+",mCenterY:"+mCenterY);
////        canvas.drawArc(mRectStripe, mStartAngle, mSweepAngle, false, mPaintStripe);
//
//    }
//
//    /**
...
//            float[] point1 = getCoordinatePoint(mRadius - shrink, angle);
//            float[] point2 = getCoordinatePoint(mBigSliceRadius - shrink - sliceShrink, angle);//控制半径就可以控制刻度线的长度
//
//            if (mStripeMode == StripeMode.NORMAL && mStripeHighlight != null) {
...
//            }
//            float[] numberPoint = getCoordinatePoint(mNumMeaRadius+15, angle);//文字距离中心半径
...
//                float[] point1 = getCoordinatePoint(mRadius - shrink-10, angle);
//                float[] point2 = getCoordinatePoint(mSmallSliceRadius - shrink - sliceShrink, angle);
//
//                if (mStripeMode == StripeMode.NORMAL && mStripeHighlight != null) {
//                    for (int j = 0; j < mStripeHighlight.size(); j++) {
//                        HighlightCR highlightCR = mStripeHighlight.get(j);
...
//        canvas.drawText((int)mRealTimeValue+mHeaderTitle, mCenterX, mCenterY - mHeaderRadius + mRectHeader.height(), mPaintText);
//
//        //绘制中心点的圆
