...
public class FlowerDialog extends BaseDialog {
    ...
    private FlowerDialog(Builder builder) {
        ...
        mTimer.scheduleAtFixedRate(new TimerTask() {
            ...
            public void run() {
                if (mFlowerView != null) {
                    ...
                    if (mBuilder.mDirection == FlowerConstant.DIRECT_CLOCKWISE) {
    ...
    public static class Builder {
        ...
        private int mDirection = FlowerConstant.DIRECT_CLOCKWISE;
        ...
        public FlowerDialog build() {
            return new FlowerDialog(this);
        }
