...
public class MyDashboardView extends View {
    ...
    public MyDashboardView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        mRadius = a.getDimensionPixelSize(R.styleable.DashboardView_radius, 200);
        ...
        mTextColor = a.getColor(R.styleable.DashboardView_textColor, Color.BLACK);
        mTextSize = a.getDimensionPixelSize(R.styleable.DashboardView_measureTextSize, 15);
